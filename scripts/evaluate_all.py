...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='sample_MDRL_20230602',
                        help='For `generated`, it is the name of the config file of the sampling experiment (e.g., sample_MDRL)'
